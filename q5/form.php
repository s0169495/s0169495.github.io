    ...
    <form action="index.php" method="POST">
        ...
        Сверхспособности:<label>
            ...
            <option value='immortality' <?php if($values['Ab0'] == 1){print 'selected';}?>>Бессмертие</option>
                <option value='passing through walls' <?php if($values['Ab1'] == 1){print 'selected';}?>>Прохождение сквозь стены</option>
                <option value='levitation' <?php if($values['Ab2'] == 1){print 'selected';}?>>Левитация</option>
            </select>
        </label><br />
